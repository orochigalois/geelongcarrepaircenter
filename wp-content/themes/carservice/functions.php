...
function cs_theme_after_setup_theme()
{
	...
	{		
		$theme_options = array(
			...
			"footer_text" => '© Copyright 2017 <a target="_blank" title="' . esc_html__('Car Service Theme', 'carservice') . '" href="' . esc_url(__('https://themeforest.net/item/car-service-mechanic-auto-shop-wordpress-theme/12777824?ref=QuanticaLabs', 'carservice')) . '">Carservice Theme</a> by <a target="_blank" title="' . esc_html__('QuanticaLabs', 'carservice') . '" href="' . esc_url(__('http://quanticalabs.com', 'carservice')) . '">QuanticaLabs</a>',
			"sticky_menu" => 0,
			"responsive" => 1,
			"scroll_top" => 1,
			"layout" => 'fullwidth',
