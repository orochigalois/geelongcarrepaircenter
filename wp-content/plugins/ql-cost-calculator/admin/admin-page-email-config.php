			...
			<table class="form-table">
				<tbody>
					<tr valign="top">
						...
						<td>
							<input type="text" class="regular-text" value="<?php echo esc_attr($cost_calculator_contact_form_options["smtp_host"]); ?>" id="smtp_host" name="smtp_host">
						</td>
					</tr>
					<tr valign="top">
						<th scope="row">
						...
						<td>
							<input type="text" class="regular-text" value="<?php echo esc_attr($cost_calculator_contact_form_options["smtp_username"]); ?>" id="smtp_username" name="smtp_username">
						</td>
					</tr>
					<tr valign="top">
						<th scope="row">
						...
						<td>
							<input type="password" class="regular-text" value="<?php echo esc_attr($cost_calculator_contact_form_options["smtp_password"]); ?>" id="smtp_password" name="smtp_password">
						</td>
					</tr>
					<tr valign="top">
						<th scope="row">
						...
						<td>
							<input type="text" class="regular-text" value="<?php echo esc_attr($cost_calculator_contact_form_options["smtp_port"]); ?>" id="smtp_port" name="smtp_port">
						</td>
					</tr>
					<tr valign="top">
						<th scope="row">
